...
--- It integrates seamlessly with QBXCore, retrieving data via lib.framework.Functions.GetPlayerData().
...
function Player.getPed()
   -- QBXCore does not store ped in PlayerData; use native function
